                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ...
                        ->arrayNode('image_gallery')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('SymEdit\Bundle\MediaBundle\Model\MediaGallery')->end()
                                ->scalarNode('repository')->end()
                                ->scalarNode('form')->defaultValue('SymEdit\Bundle\MediaBundle\Form\Type\MediaGalleryType')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
